...
Example_operators::Example_operators()
{
  ...
  m_Cubes[0] = Papyrus::Rectangle::create( -100, -100, 150, 150, Papyrus::RGBA("red", 0.5) );
  m_Cubes[1] = Papyrus::Rectangle::create( -50, -50, 150, 150, Papyrus::RGBA("green") );
  m_Cubes[2] = Papyrus::Rectangle::create( 0, 0, 150, 150, Papyrus::RGBA("blue") );
