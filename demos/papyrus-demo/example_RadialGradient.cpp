...
class Example_RadialGradient : public Gtk::Window
{
  public:
    Example_RadialGradient();
    virtual ~Example_RadialGradient();
...
{
  return new Example_RadialGradient();
}

Example_RadialGradient::Example_RadialGradient():
    m_fill_button("Fill"),
    m_stroke_button("Stroke")
{
  ...
  m_combobox.signal_changed().connect( sigc::mem_fun(*this, &Example_RadialGradient::redraw_canvas));
  m_fill_button.signal_toggled().connect( sigc::mem_fun(*this, &Example_RadialGradient::redraw_canvas));
  m_stroke_button.signal_toggled().connect( sigc::mem_fun(*this, &Example_RadialGradient::redraw_canvas));
...
void Example_RadialGradient::redraw_canvas( )
{
  int which;
  ...
  {
    Papyrus::RadialGradient::pointer gradient = Papyrus::RadialGradient::create(0.5, 0.5, 0.5, Papyrus::PERCENT);
