/* $Id: demowindow.cc,v 1.5 2008/03/02 23:57:09 rvinyard Exp $ */
    ...
    m_TextWidget_Source ( true )
{
  ...
  set_title ( "Papyrusmm Code Demos" );
...
void DemoWindow::load_file ( const Glib::ustring& filename )
{
  ...
  else
  {
    ...
    if ( !file )
    {
      Glib::ustring installed = Glib::ustring ( DEMOCODEDIR ) + Glib::ustring ( G_DIR_SEPARATOR_S ) + filename;
