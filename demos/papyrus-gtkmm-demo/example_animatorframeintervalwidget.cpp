/* Animator Frame Interval Widget
 *
 * Controls the interval (in milliseconds) between frames for a group of animators.
 */
...
class Example_AnimatorFrameIntervalWidget : public Gtk::Window
{
  public:
    Example_AnimatorFrameIntervalWidget();
    virtual ~Example_AnimatorFrameIntervalWidget();

  protected:
  //Member widgets:
    Papyrus::Gtk::AnimatorFrameIntervalWidget m_AnimatorFrameIntervalWidget;
...
{
  return new Example_AnimatorFrameIntervalWidget();
}

Example_AnimatorFrameIntervalWidget::Example_AnimatorFrameIntervalWidget()
{
  ...
  m_AnimatorFrameIntervalWidget.add( m_AffineAnimator );

  set_title("Animator Frame Interval Widget");
  set_border_width(10);

  m_vbox.pack_start( m_AnimatorFrameIntervalWidget );
  ...
  m_check.signal_toggled().connect( sigc::mem_fun( *this, &Example_AnimatorFrameIntervalWidget::on_start_stop ) );

  m_reset.set_label( "Reset" );
  m_reset.signal_clicked().connect( sigc::mem_fun( *this, &Example_AnimatorFrameIntervalWidget::on_reset ) );
...
void Example_AnimatorFrameIntervalWidget::on_start_stop()
{
...
void Example_AnimatorFrameIntervalWidget::on_reset()
{
  // TODO fix
