 ...
 ***************************************************************************/
#ifndef PAPYRUSKOCHSNOWFLAKE_H
#define PAPYRUSKOCHSNOWFLAKE_H
...
namespace Papyrus
{
  ...
  */
  class KochSnowflake : public Polyline
  {
    protected:

      KochSnowflake ( const Glib::ustring& id,
                      unsigned level,
                      double size,
                      Fill::pointer fill,
    ...
    public:
      ...
      static pointer create ( unsigned level=0,
                              double size=0.0,
